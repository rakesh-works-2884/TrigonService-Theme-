    ...
    <div>
      ...
      <main className="mx-auto max-w-5xl px-4 py-10">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-bold text-navy">Blog Posts ({posts.length})</h1>
          <Link
            href="/admin/posts/new"
            className="rounded-full bg-gradient-to-r from-navy to-cyan px-5 py-2 text-sm font-semibold text-white hover:opacity-90"
          >
            + New Post
          </Link>
        </div>
              ...
              <tbody className="divide-y divide-slate-100">
                {posts.map((post) => (
                  <tr key={post.slug}>
                    ...
                    <td className="px-5 py-4 font-medium text-navy">{post.title}</td>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <Link
                          ...
                          className="rounded-full px-3 py-1.5 text-xs font-semibold text-cyan hover:bg-cyan/10"
                        >
                          Edit
                        </Link>
