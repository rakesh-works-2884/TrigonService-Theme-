  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-3xl space-y-6 px-4 py-16 text-slate-700 sm:px-6 lg:px-8">
        ...
        <div>
          <h2 className="text-lg font-semibold text-navy">1. Service-Based Engagements</h2>
        ...
        <div>
          <h2 className="text-lg font-semibold text-navy">2. Before Filing Begins</h2>
          <p className="mt-2 leading-relaxed">
        ...
        <div>
          <h2 className="text-lg font-semibold text-navy">3. After Filing Has Begun</h2>
          <p className="mt-2 leading-relaxed">
        ...
        <div>
          <h2 className="text-lg font-semibold text-navy">4. Government Fees</h2>
          <p className="mt-2 leading-relaxed">
        ...
        <div>
          <h2 className="text-lg font-semibold text-navy">5. Requesting a Refund</h2>
          <p className="mt-2 leading-relaxed">
