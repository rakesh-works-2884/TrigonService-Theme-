  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-3xl space-y-6 px-4 py-16 text-slate-700 sm:px-6 lg:px-8">
        ...
        <div>
          <h2 className="text-lg font-semibold text-heading">2. Scope of Services</h2>
          <p className="mt-2 leading-relaxed">
        ...
        <div>
          <h2 className="text-lg font-semibold text-heading">3. Client Responsibilities</h2>
          <p className="mt-2 leading-relaxed">
        ...
        <div>
          <h2 className="text-lg font-semibold text-heading">4. Limitation of Liability</h2>
          <p className="mt-2 leading-relaxed">
        ...
        <div>
          <h2 className="text-lg font-semibold text-heading">5. Governing Law</h2>
          <p className="mt-2 leading-relaxed">
